...
namespace CarModels
{
    public class Eco:Car,IBrand
    {
        ...
        public Eco(){}
        public Eco(int engineNumber,int chasisNumber,string brandName,string modelName,string fueltype, int numberOfSeats, string color, double tankCapacity, double numberOfKmDriven):base(fueltype,numberOfSeats,color,tankCapacity,numberOfKmDriven)
        {
            s_makingID++;
            MakingID=s_makingID;
